...
The hybrid modeling workflow achieves highly precise predictions on the hold-out test set (3,351 samples) in the original scale (g/km):

| Evaluation Metric | Standard MLP (Backpropagation) | GGO-MLP Hybrid | Improvement |
| :--- | :--- | :--- | :--- |
| **MSE** (g²/km²) | 126.82917 | 126.74257 | **0.068%** |
| **RMSE** (g/km) | 11.26185 | 11.25800 | **0.034%** |
| **R² Score** | 0.95938 | 0.95941 | **0.003%** |
| **MAE** (g/km) | 4.76377 | 4.71847 | **0.951%** |

*Interpretation*: The GGO-MLP hybrid successfully improves on standard backpropagation, yielding a final Mean Absolute Error of **4.718 g/km** and explaining **95.94%** of emissions variance.
